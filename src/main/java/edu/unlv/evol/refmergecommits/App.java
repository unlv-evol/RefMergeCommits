...
public class App {
    ...
    private static final String DEFAULT_REPOS_FILE = "https://github.com/PaNaVTEC/Clean-Contacts";
...
//            System.setProperty("env.connections.file", dbPropertiesFile);
            ...
            AnalyzeMergeCommits analyzeMergeCommits = new AnalyzeMergeCommits(reposFile, clonePath);
            analyzeMergeCommits.start();
        } catch (Exception e) {
            e.printStackTrace();
            printHelp();
        }
...
//                .create("d"));
    ...
    private static void printHelp() {
        ...
        formatter.printHelp( "java -jar refmergecommits.jar [OPTIONS]", createOptions());
    }
}
